...
describe('generateTransactions', () => {
    ...
    //     expect(mockRequest.transaction[0].date).toBe('2023-07-01');
    //     expect(mockRequest.transaction[1].date).toBe('2023-07-02');
    //     expect(mockRequest.transaction[2].date).toBe('2023-07-03');
    //     expect(mockRequest.transaction[3].date).toBe('2023-07-04');
    // });
});
