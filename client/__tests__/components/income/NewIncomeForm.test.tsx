...
describe("NewIncomeForm", () => {
  it("renders the component", async () => {
    ...
    expect(screen.getByLabelText("Income end date enabled")).not.toBeChecked();

    // Check the "Income end date" checkbox
    await userEvent.click(screen.getByLabelText("Income end date enabled"));

    expect(screen.getByLabelText("Income end date enabled")).toBeChecked();

    expect(screen.getByLabelText("Income end date")).toHaveValue(
      dayjs().format("MM/DD/YYYY hh:mm A")
    );
